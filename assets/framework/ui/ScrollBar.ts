...
@ccclass
export default class ScrollBar extends cc.Component {
  @property(cc.Sprite)
  bar: cc.Sprite = null!;
  ...
  updateBackground() {
    if (this.scrollView) {
      ...
      if (this.direction == VDScrollBarDirection.VERTICAL) {
        ...
        let x =
          this.scrollView.node.getComponent(cc.UITransform)!.width * (1 - this.scrollView.node.getComponent(cc.UITransform)!.anchorX) -
          this.node.getComponent(cc.UITransform)!.width * (1 - this.node.getComponent(cc.UITransform)!.anchorX) * this.node.getScale().x;
        let y =
          this.scrollView.node.getComponent(cc.UITransform)!.height * (1 - this.scrollView.node.getComponent(cc.UITransform)!.anchorY) -
          this.node.getComponent(cc.UITransform)!.height * (1 - this.node.getComponent(cc.UITransform)!.anchorY) * this.node.getScale().y;
        ...
        let x =
          ...
          this.node.getComponent(cc.UITransform)!.height * (1 - this.node.getComponent(cc.UITransform)!.anchorY) * this.node.getScale().y;
        let y =
          -this.scrollView.node.getComponent(cc.UITransform)!.height * this.scrollView.node.getComponent(cc.UITransform)!.anchorY +
          this.node.getComponent(cc.UITransform)!.width * (1 - this.node.getComponent(cc.UITransform)!.anchorX) * this.node.getScale().x;
        this.node.setPosition(x, y);
      }
  ...
  updateScrollBar() {
    ...
    if (this.direction == VDScrollBarDirection.VERTICAL) {
      let x =
        this.node.getComponent(cc.UITransform)!.width * (1 - this.node.getComponent(cc.UITransform)!.anchorX) -
        this.bar.node.getComponent(cc.UITransform)!.width * (1 - this.bar.node.getComponent(cc.UITransform)!.anchorX) * this.bar.node.getScale().x;
      let y =
        this.node.getComponent(cc.UITransform)!.width * (1 - this.node.getComponent(cc.UITransform)!.anchorX) -
        this.bar.node.getComponent(cc.UITransform)!.width * (1 - this.bar.node.getComponent(cc.UITransform)!.anchorX) * this.bar.node.getScale().x;
