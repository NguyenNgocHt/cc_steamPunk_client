...
import { EventListener, EventListenerName } from './EventListener';
const { ccclass, property } = _decorator;

@ccclass('PotraitCanvasResize')
export class PotraitCanvasResize extends Component {
    _thisOnResized: any;
    ...
    onScreenResized() {
        this.updateCanvasAttributes();
        EventListener.dispatchEvent(EventListenerName.RESIZE_WINDOW_EVENT, this);
    }
