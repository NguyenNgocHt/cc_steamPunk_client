...
export default class AsyncTaskMgr extends cc.Component {
  private _pool: TaskContainer[] = [];
  private _isRunning = true;
  private _lastestTimeStamp: number = 0;

  private static _instance: AsyncTaskMgr = null;
  public static get instance(): AsyncTaskMgr {
    if (AsyncTaskMgr._instance == null) {
      AsyncTaskMgr._instance = new AsyncTaskMgr();
    }
   ...
   * @param taskContainer
   */
  executeTask(taskContainer: TaskContainer) {
